...
public class UserControler {
	...
	public ResponseEntity<BaseResBody<Void>> patchNickname(@PathVariable(name = "userId") Integer userId, @RequestBody @Valid UserReqDto.Nickname dto){
		this.userService.modifyNickname(userId, this.authService.authenticate(), dto.getNickname());
		return new BaseResBody<Void>(null, "nickname updated")
				.toResponse(HttpStatus.OK);
	}
}
