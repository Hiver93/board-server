...
public class UserService {
	...
	public User getUser(String username, String password) {
		User saved = this.userRepository.findByUsername(username).orElseThrow(()->{throw new BoardException(ErrorCode.INVLAID_CREDENTIALS);});
		if(!passwordEncoder.matches(password, saved.getPassword())) {
			throw new BoardException(ErrorCode.INVLAID_CREDENTIALS);
		}
		return saved;
	}
	...
	@Transactional
	public void modifyNickname(Integer userId, User user, String nickname) {
