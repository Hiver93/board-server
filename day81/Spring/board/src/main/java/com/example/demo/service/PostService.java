...
public class PostService {
	...
	public Page<Post> getPostPage(Pageable pageable, String keyword, Set<String> target){
		...
		if(title && content) {
			...
			page = this.postRepository.findByUser_NicknameContaining(pageable, keyword);
		}
		else {
