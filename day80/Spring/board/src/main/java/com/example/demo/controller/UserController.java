...
public class UserController {
	...
	@GetMapping("/{userId}")
	public ResponseEntity<BaseResBody<Profile>> getPofile(@PathVariable(name = "userId") Integer userId){
	...
	public ResponseEntity<BaseResBody<Void>> removeUser(@PathVariable(name = "userId") Integer userId, UserReqDto.Delete dto){
