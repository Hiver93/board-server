...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<BaseResBody> boardExceptin(BoardException boardException){
		return BaseResBody.buildResponseEntity(boardException.getErrorCode().getStatus(), boardException.getErrorCode().getMessage());
	}
