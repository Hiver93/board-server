...
public class PostFacade {
	...
	@Transactional
	public void addComment(Integer postId, CommentReqDto.Creaate dto) {
		User user = this.authService.authenticate();
		Post post = this.postService.getPost(postId);
		post.addComment(this.commentService.createComment(post, dto.getContent(), user));
	}
	...
	public void addPostLike(Integer postId) {
		User user = this.authService.authenticate();
		Post post = this.postService.getPost(postId);
		post.addPostLike(this.postLikeService.createPostLike(post, user));
	}
