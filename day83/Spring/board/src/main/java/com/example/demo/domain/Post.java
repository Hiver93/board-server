...
public class Post {
	...
	private User user;
	@OneToOne(fetch = FetchType.LAZY, mappedBy = "post", cascade = {CascadeType.REMOVE, CascadeType.PERSIST}, orphanRemoval = true)
	private Image image;
	@Column
	private Integer view = 0;
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "post", cascade = {CascadeType.REMOVE, CascadeType.PERSIST}, orphanRemoval = true)
