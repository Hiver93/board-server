...
public class PostFacade {
	...
	public void addComment(Integer postId, CommentReqDto.Create dto) {
		...
		Comment savedComment = this.commentService.createComment(dto.getContent(), post, this.authService.authenticate());
	...
	public void removeLike(Integer postId) {
		Post post = this.postService.getPost(postId);
		this.postLikeService.removePostLike(post, this.authService.authenticate());
	}
}
