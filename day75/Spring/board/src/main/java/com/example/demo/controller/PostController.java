...
public class PostController {
	...
	@GetMapping("/{postId}")
	public ResponseEntity<BaseResBody<Detail>> getPostList(@PathVariable(name = "postId") Integer postId){
	...
	public ResponseEntity<BaseResBody<Void>> getPostList(@PathVariable(name = "postId") Integer postId, @RequestBody @Valid PostReqDto.Delete dto){
	...
	@PutMapping("/{postId}")
	public ResponseEntity<BaseResBody<Void>> getPostList(@PathVariable(name = "postId") Integer postId, @RequestBody @Valid PostReqDto.Put dto){
