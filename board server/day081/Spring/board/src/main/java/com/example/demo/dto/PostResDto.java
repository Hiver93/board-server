...
public class PostResDto {
	...
	public static record PostList(
		...
		public static PostList from(Page<Post> postPage) {
			return new PostList(postPage.getTotalElements(), postPage.getContent().stream().map(PostItem::from).toList());
		}
