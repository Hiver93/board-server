...
public class PostController {
	...
	@PutMapping("/{postId}")
	public ResponseEntity<BaseResBody<Void>> putPost(@PathVariable(name = "postId") Integer postId, @RequestPart(name = "post") @Valid PostReqDto.Put dto, @RequestPart(name = "image", required = false) MultipartFile image) throws IOException{
	...
	public ResponseEntity<BaseResBody<Void>> putComment(@PathVariable(name = "commentId") Integer commentId, @RequestBody @Valid CommentReqDto.Put dto){
	...
	public ResponseEntity<BaseResBody<Void>> putComment(@PathVariable(name = "commentId") Integer commentId){
	...
	public ResponseEntity<BaseResBody<Void>> postPostLikes(@PathVariable(name = "postId") Integer postId){
	...
	public ResponseEntity<BaseResBody<Void>> deletePostLikes(@PathVariable(name = "postId") Integer postId){
		this.postFacade.removePostList(postId);
