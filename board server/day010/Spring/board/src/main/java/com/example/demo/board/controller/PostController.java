...
import com.example.demo.board.dto.PostRequestDto;
...
public class PostController {
	...
	@GetMapping
	public List<Post> getPostList(Pageable pageable, @RequestParam(name="keyword") String keyword){
	...
	public void deletePost(@PathVariable(name="postId") long postId, PostRequestDto.Delete dto) {
		this.postService.deletePost(postId, dto.getPassword());
	}
	
	@PutMapping("/{postId}")
	public void putPost(@PathVariable(name="postId") long postId, PostRequestDto.Post dto) {
		Post post = new Post();
		post.setId(postId);
		post.setTitle(dto.getTitle());
		post.setContent(dto.getContent());
