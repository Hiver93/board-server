...
public class Post {
	...
	private User user;
	@OneToOne(fetch = FetchType.LAZY, mappedBy = "post", cascade = {CascadeType.REMOVE, CascadeType.MERGE})
	private Image image;
	@Column
	private Integer view;
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "post", cascade = {CascadeType.REMOVE, CascadeType.MERGE})
