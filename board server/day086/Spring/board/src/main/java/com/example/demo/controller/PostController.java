...
public class PostController {
	...
	public ResponseEntity<BaseResBody<Void>> putComment(@PathVariable(name = "postId") Integer postId, @RequestBody @Valid CommentReqDto.Put dto){
	...
	public ResponseEntity<BaseResBody<Void>> deleteLike(@PathVariable(name = "postId") Integer postId){
