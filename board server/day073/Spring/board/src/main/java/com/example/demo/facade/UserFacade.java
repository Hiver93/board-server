...
public class UserFacade {
	...
	public void removeUser(Integer userId, UserReqDto.Delete dto) {
		...
		this.userService.removeUser(userId, dto.getPassword(), this.authService.getAuthentiction());
	}
	
	public void modifyUser(Integer userId, UserReqDto.Put dto) {
		this.authService.authenticate();
		this.userService.modifyUser(userId, dto.getNickname(), this.authService.getAuthentiction());
	}
}
