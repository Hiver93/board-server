...
public class PostService {
	...
	public void addComment(Comment comment) {
		Post saved = this.postRepository.findById(comment.getPost().getId()).orElseThrow(()->{throw new BoardException(ErrorCode.POST_NOT_FOUND);});
		saved.getCommentList().add(comment);
		this.postRepository.save(saved);
