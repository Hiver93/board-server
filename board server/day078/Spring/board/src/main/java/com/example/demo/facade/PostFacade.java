...
public class PostFacade {
	...
	public void addPostLike(Integer postId) {
		Post saved = this.postService.getPost(postId);
		saved.addPostLike(this.postLikeService.createPostLike(saved, this.authService.authenticate()));
	}
	
	public void removePostLike(Integer postId) {
		Post saved = this.postService.getPost(postId);
		this.postLikeService.removePostLike(saved, this.authService.authenticate());
	}
}
