...
public class PostService {
	...
	public void increaseView(Integer postId) {
		throw new BoardException(ErrorCode.POST_NOT_FOUND);
...
//		saved.increaseView();
	...
	public void removePostLike(Integer postId, User user) {				
		this.postLikeRepository.delete(
				this.postLikeRepository.findByUserIdAndPostId(user.getId(), postId)
				.orElseThrow(()->{throw new BoardException(ErrorCode.POST_LIKE_NOT_FOUND);})
				);
	}
}
