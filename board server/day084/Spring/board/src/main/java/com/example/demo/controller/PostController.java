...
public class PostController {
	...
	@PostMapping
	public ResponseEntity<BaseResBody<Void>> postPost(@RequestPart(name = "post") PostReqDto.Craete dto, @RequestPart(name = "image", required = false) MultipartFile image) throws IOException{
