...
public class UserController {
	...
	public ResponseEntity<BaseResBody<Void>> login(@PathVariable(name = "userId") Integer userId, @RequestBody @Valid UserReqDto.Delete dto){
	...
	@PutMapping("/{userId}")
	public ResponseEntity<BaseResBody<Void>> login(@PathVariable(name = "userId") Integer userId, @RequestBody @Valid UserReqDto.Put dto){
	...
	@GetMapping("/{userId}")
	public ResponseEntity<BaseResBody<Profile>> login(@PathVariable(name = "userId") Integer userId){
