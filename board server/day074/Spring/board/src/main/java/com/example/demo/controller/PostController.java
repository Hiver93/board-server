...
public class PostController {
	...
	public ResponseEntity<BaseResBody<Void>> deletePost(@PathVariable(name = "postId") Integer postId, @RequestBody PostReqDto.Delete dto){
	...
	public ResponseEntity<BaseResBody<Void>> postComment(@PathVariable(name = "postId") Integer postId, CommentReqDto.Create dto){
	...
	public ResponseEntity<BaseResBody<Void>> deleteLike(@PathVariable(name = "postId") Integer postId){
		this.postFacade.removeLike(postId);
