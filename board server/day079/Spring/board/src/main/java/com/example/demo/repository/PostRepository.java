...
public interface PostRepository extends JpaRepository<Post, Integer>{
	...
	public long countByTitleContainingOrContentContaining(String title, String cotent);
	public long countByTitleContaining(String title);
	public long countByContentContaining(String cotent);
	public long countByUser_NicknameContaining(String nickname);
