...
public enum ErrorCode {
	...
	INCCORECT_PASSWORD(HttpStatus.FORBIDDEN, "incorrect password"),
	USER_NOT_SAME(HttpStatus.FORBIDDEN, "user not same"),
	...
	IVALID_IMAGE_TYPE(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "invalid image file type"),
