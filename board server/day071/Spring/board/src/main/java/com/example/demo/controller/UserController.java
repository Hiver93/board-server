...
public class UserController {
	...
	@PutMapping("/{userId}")
	public ResponseEntity<BaseResBody<Void>> getProfile(@PathVariable(name = "userId") Integer userId, @RequestBody @Valid UserReqDto.Put dto){
	...
	public ResponseEntity<BaseResBody<Void>> getProfile(@PathVariable(name = "userId") Integer userId, @RequestBody @Valid UserReqDto.Delete dto){
