...
public enum ErrorCode {
	...
	NOT_POST_OWNER(HttpStatus.FORBIDDEN, "not the onwer of this post"),
	...
	NOT_COMMENT_OWNER(HttpStatus.FORBIDDEN, "not the onwer of this comment"),
	
	LIKE_CONFLICT(HttpStatus.CONFLICT, "aleady like"),
	LIKE_NOT_FOUND(HttpStatus.CONFLICT, "not like yet"),;
