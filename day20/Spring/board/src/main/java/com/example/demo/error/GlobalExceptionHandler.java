...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponseBody> methodArgumentNotVaidException(MethodArgumentNotValidException methodArgumentNotValidException){
		return ResponseEntity.status(methodArgumentNotValidException.getStatusCode())
				.body(new ErrorResponseBody(methodArgumentNotValidException.getFieldError().getDefaultMessage()));
	}
}
