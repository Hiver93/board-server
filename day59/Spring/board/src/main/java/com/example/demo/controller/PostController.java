...
public class PostController {
	...
	@PutMapping("/{postId}")
	public ResponseEntity<BaseResBody<Void>> deletePost(@PathVariable(name = "postId") Integer postId, @RequestBody @Valid PostReqDto.Update dto){
	...
	public ResponseEntity<BaseResBody<Void>> postComment(@PathVariable(name = "postId") Integer postId, @RequestBody @Valid CommentReqDto.Create dto){
		this.postService.addComment(dto.getContent(), postId, this.authService.authenticate());
	...
	public ResponseEntity<BaseResBody<Void>> deletePostLike(@PathVariable(name = "postId") Integer postId){
		this.postService.removePostLike(postId, this.authService.authenticate());
