...
public enum ErrorCode {
	...
	INVALID_JWT(HttpStatus.UNAUTHORIZED, "invalid jwt"), EXPIRED_JWT(HttpStatus.UNAUTHORIZED, "expired jwt"),

	USERNAME_CONFLICT(HttpStatus.CONFLICT, "username conflict"), USER_NOT_FOUND(HttpStatus.NOT_FOUND, "user not found"),
