...
public class PostController {
	...
	@PostMapping
	public ResponseEntity<BaseResBody<Void>> postPost(@RequestPart(name = "post") @Valid PostReqDto.Create dto, @RequestPart(name = "image") MultipartFile image) throws IOException{
